...
class Main(Gtk.Window):
    def __init__(self):
        super(Main, self).__init__(title="WexLinux Welcome App")
    ...
    def on_launch_clicked(self, widget, event, link):
        if os.path.isfile("/usr/bin/archlinux-tweak-tool"):
            ...
            md.format_secondary_markup(
                "<b>Wex Linux Tweak Tool</b> was not found on your system\n\
Do you want to install it?")
    ...
    def installATT(self):
        ...
        GLib.idle_add(self.MessageBox,
                      "Success!",
                      "<b>Wex Linux Tweak Tool</b> has been installed successfully")  # noqa
